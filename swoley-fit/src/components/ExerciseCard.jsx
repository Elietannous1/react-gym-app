  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
      <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4'>
        ...
        <h2 className='capitalize whitesapce-nowrap trucate max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:text-center'>{exercise.name.replaceAll("_", " ")}</h2>
        <p className='text-s text-slate-400 capitalize '> {exercise.type}</p>
      </div>
    ...
    <div className='grip grid-cols-2 sm:grids-col-4 sm:place-items-center gap-2'>
